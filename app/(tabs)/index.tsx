...
const FEATURE_SLIDES = [
  {
    ...
    image: require('@/assets/images/church_exterior_hero.png'),
    route: '/(modals)/mass',
    tag: 'Mass Scheduling',
  },
  {
    ...
    image: require('@/assets/images/bible_study_hero.png'),
    route: '/(tabs)/bible',
    tag: 'Bible Study',
  },
  {
    ...
    image: require('@/assets/images/church_interior_hero.png'),
    route: '/(tabs)/finance',
    tag: 'Giving & Finance',
  },
  {
    ...
    image: require('@/assets/images/church_community_hero.png'),
    route: '/(tabs)/groups',
